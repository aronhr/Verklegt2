...
urlpatterns = [
    ...
    path('<int:id>/', views.profile_id, name="profile-id"),
    ...
    path('offers_seller/', views.offers_seller, name="profile-offers-seller"),
    path('offers_buyer/', views.offers_buyer, name="profile-offers-buyer"),
    ...
    path('editProperties/<int:id>/', views.edit_props, name="profile-edit-properties"),
