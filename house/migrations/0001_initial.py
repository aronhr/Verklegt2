# Generated by Django 2.2.1 on 2019-05-06 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seller', to='profiles.User')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buyer', to='profiles.User')),
            ],
        ),
        migrations.CreateModel(
            name='HouseInfo',
